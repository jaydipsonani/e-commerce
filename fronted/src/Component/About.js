                        ...
                        <div className="row">
                            <div className="col-md-6 col-sm-12 col-lg-4" > 
                                <div className="team-member">
                                    <Image src={require(`./image/i.webp`)} alt="Team Member 1" roundedCircle />
                                    <h4>John Doe</h4>
                                    <p>Founder & CEO</p>
                                </div>
                            </div>
                            <div className="col-md-6 col-sm-12 col-lg-4">
                                <div className="team-member">
                                    <Image src={require(`./image/amit.webp`)} alt="Team Member 2" roundedCircle />
                                    <h4>Jane Smith</h4>
                                    <p>Head of Design</p>
                                </div>
                            </div>
                            <div className="col-md-6 col-sm-12 col-lg-4">
                                <div className="team-member">
                                    <Image src={require(`./image/aman.webp`)} alt="Team Member 3" roundedCircle />
                                    <h4>Michael Brown</h4>
